...
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Dhanalakshmi S",
                   page_icon= icon,
                   layout= "wide",
...
selected = option_menu("Phonepe Pulse | The Beat Of Progress", ["Home","Explore Data","Insights","About"],
...
# -------------------------------------------------- EXPLORE DATA   - USER
            ...
            with tab2:
                        ...
                        with col3:
                            brand = st.selectbox('***Select Brand_Name***', ('Xiaomi', 'Samsung','Vivo','Oppo','OnePlus','Realme','Apple','Motorola','Lenovo','Huawei','Others','Tecno'), key='brand')

              
                            mycursor.execute(f"SELECT State, SUM(Count),Brand_Name FROM aggregate_user WHERE Year = '{yr}' AND Quarter = '{qtr}' AND Brand_Name= '{brand}' GROUP BY State , Brand_Name;")
...
###########################################################################  ANALYSIS OVER CHART
    ...
    with tabc:                                               #----TOP CHARTS -------------------------------->TRANSACTION
...
def about():                                                            
 if selected == "About":
    ...
    with col2:
        ...
        st.write(" ")
        st.image("Phpe.png ")
    col11,col12 = st.columns([3,3],gap="large")
    with col11:
            st.write(" ")
            st.markdown("# :violet[**Categories**]")
            st.write(" ")
            st.markdown(" ## **Recharge & bill payments**     74,96,74,246")
            st.markdown("## **Peer-to-peer Payments** - 3,07,42,50,150")
            st.markdown("## **Merchant Payments** - 3,74,88,51,071")
    with col12:
            st.write(" ")
            st.write(" ")
            st.write(" ")
    ...
    col13,col14 = st.columns([3,3],gap="large")
    with col13:
            st.write(" ")
            st.write(" ")
            st.write(" ")
    ...
    col15,col16 = st.columns([3,3],gap="large")
    with col15:
            st.write(" ")
            st.write(" ")
            st.write(" ")
    ...
    col17,col18 = st.columns([3,3],gap="large")
    with col17:
            st.write(" ")
            st.write(" ")
            st.write(" ")
            st.markdown("## :violet[**GitHub**]")
    ...
    with col18:
            ...
            st.write(" ")
            st.write(" ")
            st.link_button("# :violet[**Open**]","https://github.com/Dhanalakshmi177/Capstone-project-2")
about()
